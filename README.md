...
- Photoshop/Illustrator-style Properties panel: Transform (X/Y/W/H), opacity, layer order, multi-select alignment and distribute-evenly, and Media info
...
npm run build:win
```
Output: `dist/Kanvaz Setup 7.14.0.exe` and `dist/Kanvaz 7.14.0.exe`

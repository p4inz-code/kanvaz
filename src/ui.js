...
var KanvazUI_Extended = (function() {
        ...
        (function(entry) {
          ...
          useBtn.onclick = function() {
            ...
            KanvazBridge.loadTemplate(entry.id).then(function(res) {
              ...
              KanvazBoards.newBoard(true, entry.name, res.cards);
              KanvazApp.markDirty();
              KanvazHistory.push();
              close();
  ...
  function showAbout() {
    ...
    box.innerHTML = [
      ...
      '<div class="about-version">Version 6.4.0</div>',
      ...
      '<div class="about-tagline">Reference Operating System<br>Actively maintained — v6.4.0</div>'
    ].join('');

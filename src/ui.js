...
var KanvazUI_Extended = (function() {
  ...
  function showAbout() {
    ...
    box.innerHTML = [
      ...
      '<div style="font-size:12px;color:var(--color-text-3);margin-bottom:16px;font-family:var(--font-mono);">Version 3.1.2</div>',
      ...
      '<div style="font-size:11px;color:var(--color-accent);line-height:1.7;margin-bottom:24px;">Reference Operating System<br>Actively developed — v3.1.2</div>'
    ].join('');
